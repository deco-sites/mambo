...
function Newsletter({ icon, title, placeholders, button }: Props) {
  return (
    <div class="flex flex-col sm:flex-row items-center gap-6">
      <div class="flex flex-row gap-8 max-w-[400px]">
      ...
      <form class="flex flex-col md:flex-row items-center gap-2 md:gap-6 font-body text-body w-full sm:w-[408px] text-[#7a7a7a]">
        <input
